PlotINCASummary_CONUS <- function(input_file, metric_name="INCA", LWMASKDIR="/Volumes/research/fer/jmgray2/MODIS/LWMASK5k_CONUS"){
  ...
  lwmask_file <- dir(LWMASKDIR, pattern=".tif", full=T)
