...
# bsub -q cnr -W 16:00 -n 16 -R "span[ptile=16]" -o /share/jmgray2/KF_multispec/kf_multifig.out.%J -e /share/jmgray2/KF_multispec/kf_multifig.err.%J R CMD BATCH --vanilla /share/jmgray2/KF_multispec/KF_multispec_figures.R
